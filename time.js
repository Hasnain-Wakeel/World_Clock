function showWorldTime() {
  ...
  const pakistan = now.toLocaleTimeString("en-US", {
    ...options,
    timeZone: "Asia/Karachi",
  });
  const america = now.toLocaleTimeString("en-US", {
    ...options,
    timeZone: "America/New_York",
  });
  const london = now.toLocaleTimeString("en-US", {
    ...options,
    timeZone: "Europe/London",
  });
  const japan = now.toLocaleTimeString("en-US", {
    ...options,
    timeZone: "Asia/Tokyo",
  });
